...
export function ConfigPanel({ config, saving, onSave, onNotify }) {
  ...
  // Hash links are generated by the system help. The panel is rendered after
  // the route changes, so scroll once the target section exists in the DOM.
  useEffect(() => {
  ...
  return html`
    <div class="flex flex-col gap-4 flex-1">
      ...
      <!-- Section: Automacao -->
      <${Section} id="automation" title="Automação">
      ...
      <${Section} id="api-models" title="API e Modelos">
        <!-- API Key -->
      ...
      <${Section} id="ai-behavior" title="Comportamento da IA">
      ...
      <${Section} id="behavior" title="Comportamento">
      ...
      <!-- Section: Avancado -->
      <${Section} id="advanced" title="Avançado">
        <!-- Max Executions -->
